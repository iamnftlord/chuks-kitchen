  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8F9FA] font-['Inter']">
      ...
      >
        ...
        <div className="relative z-10 text-white max-w-2xl">
          ...
          <button 
            ...
            className="bg-[#FF7A1B] text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-orange-600 active:scale-95 transition-all shadow-lg shadow-orange-500/30"
          >
            Browse Menu
          </button>
        </div>
      ...
      <section className="pt-24 pb-16 px-6 sm:px-12 md:px-24">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredCategories.map((cat) => (
            <div key={cat.id} className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all cursor-pointer">
      ...
      <section id="specials" className="bg-white py-20 px-6 sm:px-12 md:px-24">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
          {filteredSpecials.map((special) => (
            <div key={special.id} className="bg-[#F8F9FA] rounded-2xl overflow-hidden border border-gray-100 flex flex-col shadow-sm hover:shadow-lg transition-all">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <button className="bg-[#FF7A1B] text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-orange-600 transition-all shadow-lg active:scale-95">
            Discover New Menu
          </button>
        </div>
      </section>
